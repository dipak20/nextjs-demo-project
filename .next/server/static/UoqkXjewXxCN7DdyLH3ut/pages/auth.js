...
const user = props => __jsx("div", {
  ...
  id: "200282452"
}, ["div.jsx-200282452{border:1px solid #eee;box-shadow:0 2px 3px #ccc;padding:20px;text-align:center;}"]));
...
const authIndexPage = () => auth_jsx("div", null, auth_jsx("h1", null, "The Auth Index Page - ", props.appName), auth_jsx(User, {
  name: "Dipak",
  age: 29
}));
